        ...
        <ScrollView style={{ flex: 1, paddingHorizontal: 16 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{
            ...
            {myDream ? (
              ...
              >
                <Ionicons name="add" size={40} color="#D2691E" />
            ...
            {myDream && (
              <View style={{ marginBottom: 16 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 }}>
                  ...
                  <Text style={{ fontSize: 14, fontWeight: '600', color: '#D2691E' }}>{dreamProgress}%</Text>
                </View>
                <View style={{
                  height: 8,
                  backgroundColor: '#f0f0f0',
                  ...
                  <View style={{
                    width: `${dreamProgress}%`,
                    height: '100%',
                    backgroundColor: dreamProgress === 100 ? '#4CAF50' : '#D2691E',
                    borderRadius: 4
                  }} />
                </View>
              </View>
        ...
        <Modal visible={showDreamModal} animationType="slide">
          <SafeAreaView style={{ flex: 1, backgroundColor: '#f8f8f8' }}>
            <View style={{
              ...
              <Text style={{ color: '#8B4513', fontSize: 18, fontWeight: '700', marginLeft: 15 }}>
                소망 등록
              </Text>
            </View>
                ...
                {helpUsers.map((user, index) => (
                  <View key={index} style={{
                    ...
                    <TouchableOpacity
                      ...
                      style={{
                        backgroundColor: user.helped ? '#4CAF50' : '#D2691E',
